...
Ligand binding and dissociation changes the conformation of the receptor and therefore impact the downstream reactions. Now let's include more downstream reactions in our model.
...
In chemotaxis, the direction of flagellar rotation is also controlled by phosphorylation pathways. It starts from phosphorylation of CheA in the receptor complex, and then CheA phosphorylates CheB and CheY, and phosphorylated CheY enhances CW rotation. The sequence of phosphorylation event is called a phosphorylation cascade. We will model CheA and CheY phosphorylation in this tutorial (and CheB in next tutorial), specifically the reactions in the purple square.
