...
<!-- begin _includes/seo.html --><title>Quick-Start Guide - Minimal Mistakes</title>
...
<meta property="og:url" content="https://mmistakes.github.io/minimal-mistakes/docs/quick-start-guide/">
  ...
  <meta name="twitter:url" content="https://mmistakes.github.io/minimal-mistakes/docs/quick-start-guide/">
  ...
  <div class="masthead__inner-wrap">
    <div class="masthead__menu">
      <nav id="site-nav" class="greedy-nav">
        ...
        <a class="site-title" href="/minimal-mistakes/">
          Minimal Mistakes
          <span class="site-subtitle">A Jekyll theme</span>
        </a>
        <ul class="visible-links"><li class="masthead__menu-item">
              <a href="/minimal-mistakes/docs/quick-start-guide/">Quick-Start Guide</a>
            </li><li class="masthead__menu-item">
              <a href="/minimal-mistakes/about/">About</a>
            </li><li class="masthead__menu-item">
              <a href="/minimal-mistakes/year-archive/">Sample Posts</a>
            </li><li class="masthead__menu-item">
              <a href="/minimal-mistakes/collection-archive/">Sample Collections</a>
            </li><li class="masthead__menu-item">
              <a href="/minimal-mistakes/terms/">Terms &amp; Privacy Policy</a>
            </li></ul>
...
<nav class="nav__list">
  ...
  <ul class="nav__items">
      ...
      <li>
        ...
        <ul>
            ...
            <li><a href="/minimal-mistakes/docs/quick-start-guide/" class="active">Quick-Start Guide</a></li>
          
            <li><a href="/minimal-mistakes/docs/structure/">Structure</a></li>
          
            <li><a href="/minimal-mistakes/docs/installation/">Installation</a></li>
          
            <li><a href="/minimal-mistakes/docs/upgrading/">Upgrading</a></li>
      ...
      <li>
        ...
        <ul>
            ...
            <li><a href="/minimal-mistakes/docs/configuration/">Configuration</a></li>
          
            <li><a href="/minimal-mistakes/docs/overriding-theme-defaults/">Overriding Theme Defaults</a></li>
          
            <li><a href="/minimal-mistakes/docs/navigation/">Navigation</a></li>
          
            <li><a href="/minimal-mistakes/docs/ui-text/">UI Text</a></li>
          
            <li><a href="/minimal-mistakes/docs/authors/">Authors</a></li>
          
            <li><a href="/minimal-mistakes/docs/layouts/">Layouts</a></li>
      ...
      <li>
        ...
        <ul>
            ...
            <li><a href="/minimal-mistakes/docs/posts/">Working with Posts</a></li>
          
            <li><a href="/minimal-mistakes/docs/pages/">Working with Pages</a></li>
          
            <li><a href="/minimal-mistakes/docs/collections/">Working with Collections</a></li>
          
            <li><a href="/minimal-mistakes/docs/helpers/">Helpers</a></li>
          
            <li><a href="/minimal-mistakes/docs/utility-classes/">Utility Classes</a></li>
      ...
      <li>
        ...
        <ul>
            ...
            <li><a href="/minimal-mistakes/docs/stylesheets/">Stylesheets</a></li>
          
            <li><a href="/minimal-mistakes/docs/javascript/">JavaScript</a></li>
      ...
      <li>
        ...
        <ul>
            ...
            <li><a href="/minimal-mistakes/docs/history/">History</a></li>
          
            <li><a href="/minimal-mistakes/docs/contributing/">Contributing</a></li>
          
            <li><a href="/minimal-mistakes/docs/docs-2-2/">Old 2.2 Docs</a></li>
          
            <li><a href="/minimal-mistakes/docs/license/">License</a></li>
          
            <li><a href="/minimal-mistakes/terms/">Terms &amp; Privacy Policy</a></li>
  ...
  <article class="page" itemscope itemtype="https://schema.org/CreativeWork">
    ...
    <meta itemprop="description" content="How to quickly install and setup Minimal Mistakes for use with GitHub Pages.">
    
    <meta itemprop="dateModified" content="2020-04-27T00:00:00-04:00">
      ...
      <section class="page__content" itemprop="text">
          ...
          <aside class="sidebar__right ">
            <nav class="toc">
              ...
              <ul class="toc__menu">
  <li><a href="#installing-the-theme">Installing the theme</a>
    <ul>
      <li><a href="#gem-based-method">Gem-based method</a></li>
      <li><a href="#remote-theme-method">Remote theme method</a></li>
      <li><a href="#remove-the-unnecessary">Remove the Unnecessary</a></li>
    </ul>
  </li>
  <li><a href="#setup-your-site">Setup Your Site</a>
    <ul>
      <li><a href="#starting-fresh">Starting Fresh</a></li>
      <li><a href="#starting-from-jekyll-new">Starting from jekyll new</a></li>
      <li><a href="#migrating-to-gem-version">Migrating to Gem Version</a>
        <ul>
          <li><a href="#update-gemfile">Update Gemfile</a></li>
        </ul>
      </li>
    </ul>
  </li>
        ...
        <p>Minimal Mistakes has been developed as a <a href="http://jekyllrb.com/docs/themes/">Gem-based theme</a> for easier use, and 100% compatible with GitHub Pages when used as a remote theme.</p>
...
<figure>
  <img src="/minimal-mistakes/assets/images/mm-gh-pages.gif" alt="creating a new branch on GitHub" />
</figure>

<p>You can also install the theme by copying all of the theme files<sup id="fnref:structure"><a href="#fn:structure" class="footnote">1</a></sup> into your project.</p>
...
<figure>
  <img src="/minimal-mistakes/assets/images/mm-theme-fork-repo.png" alt="fork Minimal Mistakes" />
</figure>
...
<p>Replace <code class="language-plaintext highlighter-rouge">gem "github-pages</code> or <code class="language-plaintext highlighter-rouge">gem "jekyll"</code> with <code class="language-plaintext highlighter-rouge">gem "jekyll", "~&gt; 3.5"</code>. You’ll need the latest version of Jekyll<sup id="fnref:update-jekyll"><a href="#fn:update-jekyll" class="footnote">2</a></sup> for Minimal Mistakes to work and load all of the theme’s assets properly, this line forces Bundler to do that.</p>
...
<div class="footnotes">
  <ol>
    <li id="fn:structure">
      <p>See <a href="/minimal-mistakes/docs/structure/"><strong>Structure</strong> page</a> for a list of theme files and what they do. <a href="#fnref:structure" class="reversefootnote">&#8617;</a></p>
    </li>
    <li id="fn:update-jekyll">
      <p>You could also run <code class="language-plaintext highlighter-rouge">bundle update jekyll</code> to update Jekyll. <a href="#fnref:update-jekyll" class="reversefootnote">&#8617;</a></p>
    </li>
  </ol>
</div>
  ...
  <p class="page__date"><strong><i class="fas fa-fw fa-calendar-alt" aria-hidden="true"></i> Updated:</strong> <time datetime="2020-04-27">April 27, 2020</time></p>
  ...
  <nav class="pagination">
      ...
      <a href="/minimal-mistakes/docs/structure/" class="pagination--pager" title="Structure
">Next</a>
...
<!-- end custom footer snippets -->
  ...
  <ul class="social-icons">
    ...
    <li><a href="/minimal-mistakes/feed.xml"><i class="fas fa-fw fa-rss-square" aria-hidden="true"></i> Feed</a></li>
  </ul>
</div>
