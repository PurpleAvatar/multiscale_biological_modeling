...
Both types of particles diffuse randomly through the plane, but the *B* particles typically diffuse more quickly as the *A* particles.  In our simulation, we assume that *B* particles diffuse twice as quickly as *A* particles; in terms of the random walk, this faster diffusion means that in a single "step", an *A* particle moves twice as far as a *B* particle.
